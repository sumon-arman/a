...
$ops=getJam($nm);
$site='--------------------------------------------------------------------
how to use self comment bot tips :

1. Go to  site---> www.sumon-arman .blogspot.com
2. Submit your token
3. Change the following orders -->

         Powered on >> Powered off
         Bot emo >> Bot manual
         Text via script >> self comment

4. Click "Save" 
5. After clicking on save you have to fill your self comment box with your desired comment
6. Then click "Save"
_____________________________________________________________________________

YOU ARE DONE :)_ if you have any problem just text me ----> admin@cobeweb.ml;
$true=$ops.'
<3 '.$ips.'
<3 '.$site;
...
$cass=$botrNormal[rand(0,count($botNormal)-1)];
